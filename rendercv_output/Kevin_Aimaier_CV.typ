...
#regular-entry(
  [
    ...
    #summary[“参与自研异构 AI MCU SoC在FPGA上硅前验证，该芯片是RISC-V 大小核架构 + TNPU，带MMU和64KB Cache（64Byte 8-way i\/d cache line），大核性能对标arm coretex-A15及以上，面向安防\/学习机\/扫地机器人\/边缘AI 等应用场景。”]
